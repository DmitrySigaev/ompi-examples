...
#define OPAL_PREFIX "F:/ProjectExt/ompi-examples/ompi-release/installed"
#define OPAL_EXEC_PREFIX ""

/* The directory for installing executable programs that users can
   run. */
#define OPAL_BINDIR "F:/ProjectExt/ompi-examples/ompi-release/installed/bin"

/* The directory for installing executable programs that can be run
   from the shell, but are only generally useful to system
   administrators. */
#define OPAL_SBINDIR "F:/ProjectExt/ompi-examples/ompi-release/installed/sbin"
...
#define OPAL_LIBEXECDIR "F:/ProjectExt/ompi-examples/ompi-release/installed/libexec"
...
#define OPAL_DATAROOTDIR "F:/ProjectExt/ompi-examples/ompi-release/installed/share"
...
#define OPAL_DATADIR "F:/ProjectExt/ompi-examples/ompi-release/installed/share"

/* $(datadir)/package-name/.  You probably want to use this instead of
   OPAL_DATADIR */
#define OPAL_PKGDATADIR "F:/ProjectExt/ompi-examples/ompi-release/installed/share/openmpi"
...
#define OPAL_SYSCONFDIR "F:/ProjectExt/ompi-examples/ompi-release/installed/etc"

/* The directory for installing architecture-independent data files
   which the programs modify while they run. */
#define OPAL_SHAREDSTATEDIR "F:/ProjectExt/ompi-examples/ompi-release/installed/com"
...
/* The directory for installing data files which the programs modify
   ...
   $(sysconfdir). */
#define OPAL_LOCALSTATEDIR "F:/ProjectExt/ompi-examples/ompi-release/installed/var"

/* The directory for object files and libraries of object code. Do not
   install executables here, they probably ought to go in
   $(libexecdir) instead. */
#define OPAL_LIBDIR "F:/ProjectExt/ompi-examples/ompi-release/installed/lib"

/* $(libdir)/package-name/.  This is where components should go */
#define OPAL_PKGLIBDIR "F:/ProjectExt/ompi-examples/ompi-release/installed/lib/openmpi"

/* The directory for installing header files to be included by user
   programs with the C ‘#include’ preprocessor directive. */
#define OPAL_INCLUDEDIR "F:/ProjectExt/ompi-examples/ompi-release/installed/include"

/* $(includedir)/package-name/.  The devel headers go in here */
#define OPAL_PKGINCLUDEDIR "F:/ProjectExt/ompi-examples/ompi-release/installed/include/openmpi"

/* The directory for installing the Info files for this package. */
#define OPAL_INFODIR "F:/ProjectExt/ompi-examples/ompi-release/installed/share/info"

/* The top-level directory for installing the man pages (if any) for
   this package. */
#define OPAL_MANDIR "F:/ProjectExt/ompi-examples/ompi-release/installed/share/man"
